...
// import songPlay from '../components/songlist/index.vue'
...
const router = createRouter({
  ...
  routes: [
      ...
      children: [
        {
          path: "",
          component: () =>
            import("../components/headerFeatures/home-page-classification.vue"),
          children: [
            {
              path: "",
              component: () =>
                import("../components/homePageSet/headPage/headPage.vue"), //playlistRecommendation 组件已经成为了 homePageClassification 组件的子路由。
            ...
            // 否则会出现/songlist-details/classified-playlist这种情况
            {
              ...
              component: () =>
                import(
                  "../components/homePageSet/classifiedList/classifiedPlaylist.vue"
                ),
            },
            {
            ...
            },
            {
              ...
              name: "song-details",
              component: () =>
                import("../components/songDetails/songDetails.vue"),
            },
          ],
        },
        {
    ...
    },
    {
      path: "/song-play",
      name: "song-play",
      component: () => import("../components/playerInterface/index.vue"),
    },
    {
      path: "/studio",
      component: () => import("@/views/daw/index.vue"),
    },
    {
      path: "/:pathMatch(.*)*",
